 ...
 * @generated
 */
public class ProyectommViewProvider extends AbstractProvider implements IViewProvider {
	...
	*/
	protected boolean provides(CreateDiagramViewOperation op) {
		return ProcesoDeNegocioEditPart.MODEL_ID.equals(op.getSemanticHint())
				&& ProyectommVisualIDRegistry.getDiagramVisualID(getSemanticElement(op.getSemanticAdapter())) != -1;
	}
	...
	*/
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = ProyectommVisualIDRegistry.getNodeVisualID(op.getContainerView(), domainElement);
		} else {
			visualID = ProyectommVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!ProyectommElementTypes.isKnownElementType(elementType)
				...
				if (!ProcesoDeNegocioEditPart.MODEL_ID
						.equals(ProyectommVisualIDRegistry.getModelID(op.getContainerView()))) {
	...
	*/
	protected boolean provides(CreateEdgeViewOperation op) {
		IElementType elementType = getSemanticElementType(op.getSemanticAdapter());
		if (!ProyectommElementTypes.isKnownElementType(elementType) || (!(elementType instanceof IHintedType))) {
			return false; // foreign element type
		}
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		...
		int visualID = ProyectommVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null && visualID != ProyectommVisualIDRegistry.getLinkWithClassVisualID(domainElement)) {
	...
	*/
	public Diagram createDiagram(IAdaptable semanticAdapter, String diagramKind, PreferencesHint preferencesHint) {
		...
		diagram.setType(ProcesoDeNegocioEditPart.MODEL_ID);
	...
	*/
	public Node createNode(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		if (semanticHint == null) {
			visualID = ProyectommVisualIDRegistry.getNodeVisualID(containerView, domainElement);
		} else {
	...
	*/
	public Edge createEdge(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (ProyectommVisualIDRegistry.getVisualID(elementTypeHint)) {
		...
		case UsuarioTabla_accedidaEditPart.VISUAL_ID:
			return createUsuarioTabla_accedida_4002(containerView, index, persisted, preferencesHint);
		case ServicioTabla_accedidaEditPart.VISUAL_ID:
			return createServicioTabla_accedida_4003(containerView, index, persisted, preferencesHint);
		case MensajeTabla_accedidaEditPart.VISUAL_ID:
			return createMensajeTabla_accedida_4004(containerView, index, persisted, preferencesHint);
	...
	*/
	public Node createActor_2002(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Node label5013 = createLabel(node, ProyectommVisualIDRegistry.getType(ActorNombreEditPart.VISUAL_ID));
	...
	*/
	public Node createPrimaryKey_3002(EObject domainElement, View containerView, int index, boolean persisted,
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE.getFillStyle_FillColor(),
				FigureUtilities.RGBToInteger(fillRGB));
		Node label5002 = createLabel(node, ProyectommVisualIDRegistry.getType(PrimaryKeyNombreTipoEditPart.VISUAL_ID));
		createCompartment(node,
	...
	*/
	public Node createForeignKey_3004(EObject domainElement, View containerView, int index, boolean persisted,
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE.getFillStyle_FillColor(),
				FigureUtilities.RGBToInteger(fillRGB));
		Node label5003 = createLabel(node, ProyectommVisualIDRegistry.getType(ForeignKeyNombreTipoEditPart.VISUAL_ID));
		createCompartment(node,
	...
	*/
	public Node createAtributo_3005(EObject domainElement, View containerView, int index, boolean persisted,
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE.getFillStyle_FillColor(),
				FigureUtilities.RGBToInteger(fillRGB));
		Node label5004 = createLabel(node, ProyectommVisualIDRegistry.getType(AtributoNombreTipoEditPart.VISUAL_ID));
		createCompartment(node,
	...
	* @generated
	*/
	public Edge createTareaSucesor_4001(View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		...
		edge.setType(ProyectommVisualIDRegistry.getType(TareaSucesorEditPart.VISUAL_ID));
		...
		Node label6001 = createLabel(edge, ProyectommVisualIDRegistry.getType(WrappingLabelEditPart.VISUAL_ID));
	...
	* @generated
	*/
	public Edge createUsuarioTabla_accedida_4002(View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(ProyectommVisualIDRegistry.getType(UsuarioTabla_accedidaEditPart.VISUAL_ID));
		edge.setElement(null);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		FontStyle edgeFontStyle = (FontStyle) edge.getStyle(NotationPackage.Literals.FONT_STYLE);
		...
		Node label6002 = createLabel(edge, ProyectommVisualIDRegistry.getType(WrappingLabel2EditPart.VISUAL_ID));
	...
	* @generated
	*/
	public Edge createServicioTabla_accedida_4003(View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(ProyectommVisualIDRegistry.getType(ServicioTabla_accedidaEditPart.VISUAL_ID));
		edge.setElement(null);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		FontStyle edgeFontStyle = (FontStyle) edge.getStyle(NotationPackage.Literals.FONT_STYLE);
		...
		Node label6003 = createLabel(edge, ProyectommVisualIDRegistry.getType(WrappingLabel3EditPart.VISUAL_ID));
	...
	* @generated
	*/
	public Edge createMensajeTabla_accedida_4004(View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(ProyectommVisualIDRegistry.getType(MensajeTabla_accedidaEditPart.VISUAL_ID));
		edge.setElement(null);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		FontStyle edgeFontStyle = (FontStyle) edge.getStyle(NotationPackage.Literals.FONT_STYLE);
		...
		Node label6004 = createLabel(edge,
				ProyectommVisualIDRegistry.getType(MensajeTabla_accedidaExternalLabelEditPart.VISUAL_ID));
	...
	*/
	public Edge createBDAtributo_seleccionado_4005(View containerView, int index, boolean persisted,
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(ProyectommVisualIDRegistry.getType(BDAtributo_seleccionadoEditPart.VISUAL_ID));
		edge.setElement(null);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		FontStyle edgeFontStyle = (FontStyle) edge.getStyle(NotationPackage.Literals.FONT_STYLE);
	...
	*/
	public Edge createForeignKeyReferencia_a_4006(View containerView, int index, boolean persisted,
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(ProyectommVisualIDRegistry.getType(ForeignKeyReferencia_aEditPart.VISUAL_ID));
		edge.setElement(null);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		FontStyle edgeFontStyle = (FontStyle) edge.getStyle(NotationPackage.Literals.FONT_STYLE);
	...
	*/
	private void stampShortcut(View containerView, Node target) {
		if (!ProcesoDeNegocioEditPart.MODEL_ID.equals(ProyectommVisualIDRegistry.getModelID(containerView))) {
			EAnnotation shortcutAnnotation = EcoreFactory.eINSTANCE.createEAnnotation();
			shortcutAnnotation.setSource("Shortcut"); //$NON-NLS-1$
			shortcutAnnotation.getDetails().put("modelID", ProcesoDeNegocioEditPart.MODEL_ID); //$NON-NLS-1$
