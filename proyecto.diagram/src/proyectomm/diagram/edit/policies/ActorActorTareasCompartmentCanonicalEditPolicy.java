 ...
 * @generated
 */
public class ActorActorTareasCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return ProyectommPackage.eINSTANCE.getActor_Tareas();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ProyectommNodeDescriptor> childDescriptors = ProyectommDiagramUpdater
				.getActorActorTareasCompartment_7006SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<ProyectommNodeDescriptor> childDescriptors = ProyectommDiagramUpdater
				.getActorActorTareasCompartment_7006SemanticChildren((View) getHost().getModel());
