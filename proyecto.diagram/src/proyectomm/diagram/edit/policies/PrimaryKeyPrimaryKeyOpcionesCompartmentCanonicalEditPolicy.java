 ...
 * @generated
 */
public class PrimaryKeyPrimaryKeyOpcionesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return ProyectommPackage.eINSTANCE.getAtributo_Opciones();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ProyectommNodeDescriptor> childDescriptors = ProyectommDiagramUpdater
				.getPrimaryKeyPrimaryKeyOpcionesCompartment_7003SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return OpcionEditPart.VISUAL_ID == ProyectommVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<ProyectommNodeDescriptor> childDescriptors = ProyectommDiagramUpdater
				.getPrimaryKeyPrimaryKeyOpcionesCompartment_7003SemanticChildren((View) getHost().getModel());
