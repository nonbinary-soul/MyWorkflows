 ...
 * @generated
 */
public class AtributoAtributoOpcionesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ProyectommNodeDescriptor> childDescriptors = ProyectommDiagramUpdater
				.getAtributoAtributoOpcionesCompartment_7005SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<ProyectommNodeDescriptor> childDescriptors = ProyectommDiagramUpdater
				.getAtributoAtributoOpcionesCompartment_7005SemanticChildren((View) getHost().getModel());
