 ...
 * @generated
 */
public class BaseDeDatosBaseDeDatosTablasCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return ProyectommPackage.eINSTANCE.getBaseDeDatos_Tablas();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ProyectommNodeDescriptor> childDescriptors = ProyectommDiagramUpdater
				.getBaseDeDatosBaseDeDatosTablasCompartment_7001SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return TablaEditPart.VISUAL_ID == ProyectommVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<ProyectommNodeDescriptor> childDescriptors = ProyectommDiagramUpdater
				.getBaseDeDatosBaseDeDatosTablasCompartment_7001SemanticChildren((View) getHost().getModel());
