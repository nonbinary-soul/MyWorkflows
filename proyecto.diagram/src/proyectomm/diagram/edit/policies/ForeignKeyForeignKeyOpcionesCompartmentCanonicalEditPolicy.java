 ...
 * @generated
 */
public class ForeignKeyForeignKeyOpcionesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ProyectommNodeDescriptor> childDescriptors = ProyectommDiagramUpdater
				.getForeignKeyForeignKeyOpcionesCompartment_7004SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<ProyectommNodeDescriptor> childDescriptors = ProyectommDiagramUpdater
				.getForeignKeyForeignKeyOpcionesCompartment_7004SemanticChildren((View) getHost().getModel());
