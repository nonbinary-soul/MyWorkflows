 ...
 * @generated
 */
public class TablaTablaAtributosCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return ProyectommPackage.eINSTANCE.getTabla_Atributos();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ProyectommNodeDescriptor> childDescriptors = ProyectommDiagramUpdater
				.getTablaTablaAtributosCompartment_7002SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == PrimaryKeyEditPart.VISUAL_ID || visualID == ForeignKeyEditPart.VISUAL_ID
				|| visualID == AtributoEditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<ProyectommNodeDescriptor> childDescriptors = ProyectommDiagramUpdater
				.getTablaTablaAtributosCompartment_7002SemanticChildren((View) getHost().getModel());
