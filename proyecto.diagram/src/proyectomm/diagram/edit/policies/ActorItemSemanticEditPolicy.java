 ...
 * @generated
 */
public class ActorItemSemanticEditPolicy extends ProyectommBaseItemSemanticEditPolicy {
				...
				for (Iterator<?> cit = node.getChildren().iterator(); cit.hasNext();) {
					...
					case EnvioEditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it.hasNext();) {
							...
							if (ProyectommVisualIDRegistry
									.getVisualID(incomingLink) == TareaSucesorEditPart.VISUAL_ID) {
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							...
							if (ProyectommVisualIDRegistry
									.getVisualID(outgoingLink) == TareaSucesorEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
					...
					case BorradoEditPart.VISUAL_ID:
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							...
							if (ProyectommVisualIDRegistry
									.getVisualID(outgoingLink) == BDAtributo_seleccionadoEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										outgoingLink.getSource().getElement(), null,
										outgoingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
