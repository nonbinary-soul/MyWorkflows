 ...
 * @generated
 */
public class UsuarioTabla_accedida_por_usuarioCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public UsuarioTabla_accedida_por_usuarioCreateCommand(CreateRelationshipRequest request, EObject source,
			EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return ProyectommBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateUsuarioTabla_accedida_por_usuario_4002(getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setTabla_accedida_por_usuario(getTarget());
		}
