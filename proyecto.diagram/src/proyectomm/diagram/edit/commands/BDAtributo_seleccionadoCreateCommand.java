 ...
 * @generated
 */
public class BDAtributo_seleccionadoCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public BDAtributo_seleccionadoCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof proyectomm.BD) {
			return false;
		}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setAtributo_seleccionado(getTarget());
		}
	...
	* @generated
	*/
	protected proyectomm.BD getSource() {
		return (proyectomm.BD) source;
	}
