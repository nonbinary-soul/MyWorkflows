 ...
 * @generated
 */
public class EnvioNombreEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ProyectommVisualIDRegistry.getType(proyectomm.diagram.edit.parts.EnvioNombreEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public EnvioNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProyectommParserProvider.getParser(ProyectommElementTypes.Envio_3006, getParserElement(),
					ProyectommVisualIDRegistry.getType(proyectomm.diagram.edit.parts.EnvioNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new EnvioLabelFigure();
	}

	/**
	 * @generated
	 */
	public class EnvioLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public EnvioLabelFigure() {
			this.setText("Envio");
		}
