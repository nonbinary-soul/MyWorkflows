 ...
 * @generated
 */
public class PrimaryKeyNombreTipoEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PrimaryKeyNombreTipoEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = ProyectommParserProvider.getParser(ProyectommElementTypes.PrimaryKey_3002, getParserElement(),
					ProyectommVisualIDRegistry
							.getType(proyectomm.diagram.edit.parts.PrimaryKeyNombreTipoEditPart.VISUAL_ID));
		}
		return parser;
	}
