 ...
 * @generated
 */
public class ActorNombreEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ProyectommVisualIDRegistry.getType(proyectomm.diagram.edit.parts.ActorNombreEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProyectommParserProvider.getParser(ProyectommElementTypes.Actor_2002, getParserElement(),
					ProyectommVisualIDRegistry.getType(proyectomm.diagram.edit.parts.ActorNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
