 ...
 * @generated
 */
public class ForeignKeyNombreTipoEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ForeignKeyNombreTipoEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = ProyectommParserProvider.getParser(ProyectommElementTypes.ForeignKey_3004, getParserElement(),
					ProyectommVisualIDRegistry
							.getType(proyectomm.diagram.edit.parts.ForeignKeyNombreTipoEditPart.VISUAL_ID));
		}
		return parser;
	}
