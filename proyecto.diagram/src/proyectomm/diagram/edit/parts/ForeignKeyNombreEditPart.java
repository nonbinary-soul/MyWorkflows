...
import proyectomm.diagram.edit.policies.ProyectommTextSelectionEditPolicy;
 ...
 * @generated
 */
public class ForeignKeyNombreEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ProyectommVisualIDRegistry.getType(proyectomm.diagram.edit.parts.ForeignKeyNombreEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public ForeignKeyNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProyectommParserProvider.getParser(ProyectommElementTypes.ForeignKey_3004, getParserElement(),
					ProyectommVisualIDRegistry
							.getType(proyectomm.diagram.edit.parts.ForeignKeyNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, ProyectommEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ForeignKeyLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ForeignKeyLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ForeignKeyLabelFigure() {
			this.setText("ForeignKey");
