 ...
 * @generated
 */
public class RecepcionNombreEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ProyectommVisualIDRegistry.getType(proyectomm.diagram.edit.parts.RecepcionNombreEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public RecepcionNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProyectommParserProvider.getParser(ProyectommElementTypes.Recepcion_3007, getParserElement(),
					ProyectommVisualIDRegistry
							.getType(proyectomm.diagram.edit.parts.RecepcionNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new RecepcionLabelFigure();
	}

	/**
	 * @generated
	 */
	public class RecepcionLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public RecepcionLabelFigure() {
			this.setText("Recepcion");
		}
