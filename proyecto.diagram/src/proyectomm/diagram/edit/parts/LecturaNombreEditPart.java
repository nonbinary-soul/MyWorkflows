 ...
 * @generated
 */
public class LecturaNombreEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ProyectommVisualIDRegistry.getType(proyectomm.diagram.edit.parts.LecturaNombreEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public LecturaNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProyectommParserProvider.getParser(ProyectommElementTypes.Lectura_3009, getParserElement(),
					ProyectommVisualIDRegistry.getType(proyectomm.diagram.edit.parts.LecturaNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new LecturaLabelFigure();
	}

	/**
	 * @generated
	 */
	public class LecturaLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public LecturaLabelFigure() {
			this.setText("Lectura");
		}
