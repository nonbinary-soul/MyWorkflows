 ...
 * @generated
 */
public class PrimaryKeyNombreEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ProyectommVisualIDRegistry.getType(proyectomm.diagram.edit.parts.PrimaryKeyNombreEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public PrimaryKeyNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProyectommParserProvider.getParser(ProyectommElementTypes.PrimaryKey_3002, getParserElement(),
					ProyectommVisualIDRegistry
							.getType(proyectomm.diagram.edit.parts.PrimaryKeyNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new PrimaryKeyLabelFigure();
	}

	/**
	 * @generated
	 */
	public class PrimaryKeyLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public PrimaryKeyLabelFigure() {
			this.setText("PrimaryKey");
