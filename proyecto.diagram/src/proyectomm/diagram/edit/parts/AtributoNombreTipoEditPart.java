 ...
 * @generated
 */
public class AtributoNombreTipoEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AtributoNombreTipoEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = ProyectommParserProvider.getParser(ProyectommElementTypes.Atributo_3005, getParserElement(),
					ProyectommVisualIDRegistry
							.getType(proyectomm.diagram.edit.parts.AtributoNombreTipoEditPart.VISUAL_ID));
		}
		return parser;
	}
