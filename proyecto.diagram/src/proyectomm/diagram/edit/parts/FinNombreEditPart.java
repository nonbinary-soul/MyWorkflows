 ...
 * @generated
 */
public class FinNombreEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ProyectommVisualIDRegistry.getType(proyectomm.diagram.edit.parts.FinNombreEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public FinNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProyectommParserProvider.getParser(ProyectommElementTypes.Fin_3013, getParserElement(),
					ProyectommVisualIDRegistry.getType(proyectomm.diagram.edit.parts.FinNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new FinLabelFigure();
	}

	/**
	 * @generated
	 */
	public class FinLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public FinLabelFigure() {
			this.setText("Fin");
		}
