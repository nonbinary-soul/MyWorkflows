...
import proyectomm.diagram.edit.policies.BaseDeDatosItemSemanticEditPolicy;
...
public class BaseDeDatosEditPart extends AbstractBorderedShapeEditPart {
	...
	* @generated
	*/
	public BaseDeDatosEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new BaseDeDatosItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new BaseDeDatosFigure();
	}

	/**
	* @generated
	*/
	public BaseDeDatosFigure getPrimaryShape() {
		return (BaseDeDatosFigure) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof BaseDeDatosBaseDeDatosTablasCompartmentEditPart) {
			...
			pane.add(((BaseDeDatosBaseDeDatosTablasCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProyectommVisualIDRegistry.getType(BaseDeDatosNombreEditPart.VISUAL_ID));
	}
	...
	*/
	...
	public class BaseDeDatosFigure extends SVGFigure {
		 ...
		 * @generated
		 */
		private RectangleFigure fBaseDeDatosTablasCompartmentFigure;
		...
		private void createContents() {
			...
			fBaseDeDatosTablasCompartmentFigure.setOutline(false);

			this.add(fBaseDeDatosTablasCompartmentFigure);
