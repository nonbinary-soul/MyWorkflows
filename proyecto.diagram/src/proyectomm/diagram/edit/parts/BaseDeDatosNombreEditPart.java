 ...
 * @generated
 */
public class BaseDeDatosNombreEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ProyectommVisualIDRegistry.getType(proyectomm.diagram.edit.parts.BaseDeDatosNombreEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public BaseDeDatosNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProyectommParserProvider.getParser(ProyectommElementTypes.BaseDeDatos_2001, getParserElement(),
					ProyectommVisualIDRegistry
							.getType(proyectomm.diagram.edit.parts.BaseDeDatosNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new BaseDeDatosLabelFigure();
	}

	/**
	 * @generated
	 */
	public class BaseDeDatosLabelFigure extends WrappingLabel {
