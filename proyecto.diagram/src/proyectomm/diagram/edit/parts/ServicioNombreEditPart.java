 ...
 * @generated
 */
public class ServicioNombreEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ProyectommVisualIDRegistry.getType(proyectomm.diagram.edit.parts.ServicioNombreEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProyectommParserProvider.getParser(ProyectommElementTypes.Servicio_3011, getParserElement(),
					ProyectommVisualIDRegistry.getType(proyectomm.diagram.edit.parts.ServicioNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ServicioLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ServicioLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ServicioLabelFigure() {
			this.setText("Servicio");
		}
