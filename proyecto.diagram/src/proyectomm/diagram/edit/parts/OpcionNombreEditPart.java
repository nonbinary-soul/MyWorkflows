 ...
 * @generated
 */
public class OpcionNombreEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ProyectommVisualIDRegistry.getType(proyectomm.diagram.edit.parts.OpcionNombreEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public OpcionNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProyectommParserProvider.getParser(ProyectommElementTypes.Opcion_3003, getParserElement(),
					ProyectommVisualIDRegistry.getType(proyectomm.diagram.edit.parts.OpcionNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new OpcionLabelFigure();
	}

	/**
	 * @generated
	 */
	public class OpcionLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public OpcionLabelFigure() {
			this.setText("Opcion");
		}
