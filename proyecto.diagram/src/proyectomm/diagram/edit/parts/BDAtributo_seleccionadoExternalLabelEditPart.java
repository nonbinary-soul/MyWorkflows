 ...
 * @generated
 */
public class BDAtributo_seleccionadoExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				ProyectommVisualIDRegistry
						.getType(proyectomm.diagram.edit.parts.BDAtributo_seleccionadoExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public BDAtributo_seleccionadoExternalLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new BDAtributo_seleccionadoExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class BDAtributo_seleccionadoExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public BDAtributo_seleccionadoExternalLabelFigure() {
			this.setText("Acceso al atributo...");
		}
