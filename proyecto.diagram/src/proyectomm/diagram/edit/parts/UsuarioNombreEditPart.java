 ...
 * @generated
 */
public class UsuarioNombreEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ProyectommVisualIDRegistry.getType(proyectomm.diagram.edit.parts.UsuarioNombreEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public UsuarioNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProyectommParserProvider.getParser(ProyectommElementTypes.Usuario_3010, getParserElement(),
					ProyectommVisualIDRegistry.getType(proyectomm.diagram.edit.parts.UsuarioNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new UsuarioLabelFigure();
	}

	/**
	 * @generated
	 */
	public class UsuarioLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public UsuarioLabelFigure() {
