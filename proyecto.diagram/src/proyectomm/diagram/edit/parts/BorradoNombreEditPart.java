 ...
 * @generated
 */
public class BorradoNombreEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ProyectommVisualIDRegistry.getType(proyectomm.diagram.edit.parts.BorradoNombreEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public BorradoNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProyectommParserProvider.getParser(ProyectommElementTypes.Borrado_3008, getParserElement(),
					ProyectommVisualIDRegistry.getType(proyectomm.diagram.edit.parts.BorradoNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new BorradoLabelFigure();
	}

	/**
	 * @generated
	 */
	public class BorradoLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public BorradoLabelFigure() {
			this.setText("Borrado");
		}
