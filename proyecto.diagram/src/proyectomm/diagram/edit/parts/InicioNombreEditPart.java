 ...
 * @generated
 */
public class InicioNombreEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ProyectommVisualIDRegistry.getType(proyectomm.diagram.edit.parts.InicioNombreEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public InicioNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProyectommParserProvider.getParser(ProyectommElementTypes.Inicio_3012, getParserElement(),
					ProyectommVisualIDRegistry.getType(proyectomm.diagram.edit.parts.InicioNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new InicioLabelFigure();
	}

	/**
	 * @generated
	 */
	public class InicioLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public InicioLabelFigure() {
			this.setText("Inicio");
		}
