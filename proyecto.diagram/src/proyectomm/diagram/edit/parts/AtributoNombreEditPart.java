 ...
 * @generated
 */
public class AtributoNombreEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ProyectommVisualIDRegistry.getType(proyectomm.diagram.edit.parts.AtributoNombreEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ProyectommParserProvider.getParser(ProyectommElementTypes.Atributo_3005, getParserElement(),
					ProyectommVisualIDRegistry.getType(proyectomm.diagram.edit.parts.AtributoNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AtributoLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AtributoLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AtributoLabelFigure() {
			this.setText("Atributo");
