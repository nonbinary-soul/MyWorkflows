...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Intermedia</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public abstract class IntermediaImpl extends TareaImpl implements Intermedia {
	/**
	...
	protected EClass eStaticClass() {
		return ProyectommPackage.Literals.INTERMEDIA;
	}
	...
	public void setId(int newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProyectommPackage.INTERMEDIA__ID, oldId, id));
	}
	...
	public void setDescripcion(String newDescripcion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProyectommPackage.INTERMEDIA__DESCRIPCION, oldDescripcion, descripcion));
	}
