...
/**
 * This is the item provider adapter for a {@link proyectomm.Tabla} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TablaItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ProyectommPackage.Literals.TABLA__NOMBRE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ProyectommPackage.Literals.TABLA__ATRIBUTOS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ProyectommPackage.Literals.TABLA__ATRIBUTOS,
				 ProyectommFactory.eINSTANCE.createAtributo()));

		newChildDescriptors.add
			(createChildParameter
				(ProyectommPackage.Literals.TABLA__ATRIBUTOS,
				 ProyectommFactory.eINSTANCE.createPrimaryKey()));

		newChildDescriptors.add
			(createChildParameter
				(ProyectommPackage.Literals.TABLA__ATRIBUTOS,
				 ProyectommFactory.eINSTANCE.createForeignKey()));
	}
